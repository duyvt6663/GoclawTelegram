...
var coreToolSummaries = map[string]string{
	...
	"linkup_web_search":             "Search the web with Linkup for concise factual answers with sources",
	...
	"create_so_dau_bai_poll":        "Create a non-anonymous Telegram vote in the current group/topic to decide whether someone should be added to today's sổ đầu bài — use when the user asks to mở poll xử, vote cho ai lên sổ, or cho ai vào sổ",
	"create_so_dau_bai_pardon_poll": "Create a non-anonymous Telegram vote in the current group/topic to decide whether someone should be removed from today's sổ đầu bài — use when the user asks to thả, ân xá, gạch tên, or xóa ai khỏi sổ",
