...
type TelegramConfig struct {
	...
	ReplyToReactionMediaWithoutMention *bool               `json:"reply_to_reaction_media_without_mention,omitempty"` // allow sticker/GIF/meme-like media to trigger a brief reply without @mention (default false)
