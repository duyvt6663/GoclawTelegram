...
func (h *handler) RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("POST /v1/beta/linkup-web-search/search", httpapi.RequireAuth(permissions.RoleViewer, h.handleSearch))
}
...
func (h *handler) handleSearch(w http.ResponseWriter, r *http.Request) {
	...
	payload, err := h.feature.search(r.Context(), tenantKeyFromCtx(r.Context()), params)
	if err != nil {
