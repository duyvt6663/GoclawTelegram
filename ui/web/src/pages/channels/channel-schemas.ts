...
export const configSchema: Record<string, FieldDef[]> = {
  telegram: [
    ...
    { key: "reply_to_reaction_media_without_mention", label: "Reply To Reaction Media Without @mention", type: "boolean", defaultValue: false, help: "Let stickers, GIFs, meme images, and short reaction clips trigger a brief reply in groups even without @mention. Ordinary media should stay silent." },
